...
func TestUpdateCatalog(t *testing.T) {
	src, err := utils.NewCluster([]utils.SegConfig{
		...
		{ContentID: 0, Port: 111, Role: utils.MirrorRole, PreferredRole: utils.MirrorRole},
		{ContentID: 1, Port: 345, Role: utils.PrimaryRole, PreferredRole: utils.PrimaryRole},
		{ContentID: 1, Port: 222, Role: utils.MirrorRole, PreferredRole: utils.MirrorRole},
		{ContentID: 2, Port: 456, Role: utils.PrimaryRole, PreferredRole: utils.PrimaryRole},
		{ContentID: 2, Port: 333, Role: utils.MirrorRole, PreferredRole: utils.MirrorRole},
	})
