...
func TestWriteSegmentArray(t *testing.T) {
	...
	t.Run("renders the config file as expected", func(t *testing.T) {
		initializeConfig := InitializeConfig{
			Master: utils.SegConfig{ContentID: -1, DbID: 1, Hostname: "mdw", DataDir: "/data/qddir/seg-1", Role: "p", Port: 15433},
			Primaries: []utils.SegConfig{
				{ContentID: 0, DbID: 2, Hostname: "sdw1", DataDir: "/data/dbfast1/seg1", Role: "p", PreferredRole: "p", Port: 15434},
				{ContentID: 1, DbID: 3, Hostname: "sdw2", DataDir: "/data/dbfast2/seg2", Role: "p", PreferredRole: "p", Port: 15434},
				{ContentID: 2, DbID: 4, Hostname: "sdw1", DataDir: "/data/dbfast3/seg3", Role: "p", PreferredRole: "p", Port: 15435},
			},
		}

		test(t, initializeConfig, []string{
			...
			"\tsdw1~15435~/data/dbfast3_upgrade/seg3~4~2~0",
			")",
		})
	})
