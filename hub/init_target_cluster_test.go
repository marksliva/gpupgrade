	...
	t.Run("renders the config file as expected", func(t *testing.T) {
		initializeConfig := InitializeConfig{
			...
			Primaries: []utils.SegConfig{
				{ContentID: 0, DbID: 2, Hostname: "sdw1", DataDir: "/data/dbfast1/seg1", Role: "p", Port: 15434},
				{ContentID: 1, DbID: 3, Hostname: "sdw2", DataDir: "/data/dbfast2/seg2", Role: "p", Port: 15434},
				{ContentID: 2, DbID: 4, Hostname: "sdw1", DataDir: "/data/dbfast3/seg3", Role: "p", Port: 15435},
			},
		}
