	...
	t.Run("renders the config file as expected", func(t *testing.T) {
		initializeConfig := InitializeConfig{
			...
			Mirrors: []utils.SegConfig{
				{ContentID: 0, DbID: 4, Hostname: "sdw1", DataDir: "/data/dbfast_mirror1_upgrade/seg1", Role: "m", PreferredRole: "m", Port: 15435},
				{ContentID: 1, DbID: 5, Hostname: "sdw2", DataDir: "/data/dbfast_mirror2_upgrade/seg2", Role: "m", PreferredRole: "m", Port: 15435},
			},
...
func TestCreateSegmentDataDirectories(t *testing.T) {
	// todo: clean up target cluster, or replace it with the InitializeConfig
	testhelper.SetupTestLogger() // initialize gplog
