...
type Message_Data struct {
	Data *DataMap `protobuf:"bytes,3,opt,name=data,proto3,oneof"`
}
...
func (*Message_Data) isMessage_Contents() {}
...
func (m *Message) GetData() *DataMap {
	if x, ok := m.GetContents().(*Message_Data); ok {
		return x.Data
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*DataMap)(nil), "idl.DataMap")
	proto.RegisterMapType((map[string]string)(nil), "idl.DataMap.DataEntry")
...
var fileDescriptor_631e66a01873be02 = []byte{
	...
	,
}
