...
type UpdateRecoveryConfsRequest struct {
	RecoveryConfInfos    []*RecoveryConfInfo `protobuf:"bytes,1,rep,name=RecoveryConfInfos,proto3" json:"RecoveryConfInfos,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *UpdateRecoveryConfsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateRecoveryConfsRequest.Merge(m, src)
}
...
func (m *UpdateRecoveryConfsReply) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateRecoveryConfsReply.Merge(m, src)
}
...
type RecoveryConfInfo struct {
	TemporaryPort        int32    `protobuf:"varint,1,opt,name=TemporaryPort,proto3" json:"TemporaryPort,omitempty"`
	SourcePort           int32    `protobuf:"varint,2,opt,name=SourcePort,proto3" json:"SourcePort,omitempty"`
...
func (m *RecoveryConfInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RecoveryConfInfo.Merge(m, src)
}
...
func (m *RecoveryConfInfo) GetTemporaryPort() int32 {
	if m != nil {
		return m.TemporaryPort
	}
	return 0
}

func (m *RecoveryConfInfo) GetSourcePort() int32 {
	if m != nil {
		return m.SourcePort
	}
	return 0
...
func (m *RecoveryConfInfo) GetDataDir() string {
	if m != nil {
		return m.DataDir
	}
	return ""
...
var fileDescriptor_9e73bb06acc917d8 = []byte{
	...
	,
}
...
func (c *agentClient) UpdateRecoveryConfs(ctx context.Context, in *UpdateRecoveryConfsRequest, opts ...grpc.CallOption) (*UpdateRecoveryConfsReply, error) {
	...
	err := c.cc.Invoke(ctx, "/idl.Agent/UpdateRecoveryConfs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedAgentServer) UpdateRecoveryConfs(ctx context.Context, req *UpdateRecoveryConfsRequest) (*UpdateRecoveryConfsReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateRecoveryConfs not implemented")
}
